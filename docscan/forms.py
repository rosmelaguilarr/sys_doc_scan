...
class DocumentForm(ModelForm):
    ...
    class Meta:     
        ...
        widgets = {
            ...
            # 'doctype': forms.Select(attrs={'class': 'select form-select'}),
            # 'origin': forms.Select(attrs={'class': 'select form-select'}),
        }
